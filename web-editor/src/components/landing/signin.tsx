...
export default function Login() {
  return (<div className="flex flex-col align-center">
    ...
    <div className="grid p-4 gap-4 sm:grid-cols-2 grid-cols-1">
      ...
      <button
        className="bg-white border-2 border-slate-200 rounded-xl p-2 w-[210px] flex text-black text-center text-red-800 font-semibold items-center justify-between"
        onClick={async () => {
          await signIn.social({
            provider: "github",
          });
